...
var $author$project$Main$updateUrl = F2(
	function (url, model) {
		var relativeUrl = _Utils_update(
			url,
			{
				path: A3($elm$core$String$replace, model.basePath, '', url.path)
			});
		var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$parser, relativeUrl);
		if (_v0.$ === 'Just') {
			if (_v0.a.$ === 'HomeRoute') {
				var _v1 = _v0.a;
				return _Utils_Tuple2(
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return A2(
			...
			url,
			{basePath: basePath, key: key, page: $author$project$Common$NotFound, url: url});
	});
	...
	var subtitle = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('Baby don\'t hurt me'))
			]));
	var logo = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'basePath', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedLink":["Browser.UrlRequest"],"ChangedUrl":["Url.Url"],"GotElmuiMsg":["Pages.Elmui.Msg"],"GotHomePageMsg":["Pages.Home.Msg"],"Increment":[],"Decrement":[],"NoOp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Pages.Elmui.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[],"NoOp":[]}},"Pages.Home.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});
...
},{"./Main.elm":"src/Main.elm"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
