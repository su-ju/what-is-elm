...
var author$project$Common$NotFound = {$: 'NotFound'};
var author$project$Common$ElmuiPage = function (a) {
	return {$: 'ElmuiPage', a: a};
};
var author$project$Common$HomePage = function (a) {
	return {$: 'HomePage', a: a};
};
var author$project$Common$ElmuiQuery = function (a) {
	return {$: 'ElmuiQuery', a: a};
};
var author$project$Common$HomeRoute = {$: 'HomeRoute'};
...
var author$project$Main$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Common$HomeRoute, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Common$ElmuiQuery,
			A2(
				elm$url$Url$Parser$questionMark,
				elm$url$Url$Parser$s('elmui'),
				elm$url$Url$Parser$Query$string('q')))
		]));
var elm$core$String$toInt = _String_toInt;
var author$project$Pages$Elmui$createModel = function (val) {
	var res = elm$core$String$toInt(val);
	if (res.$ === 'Just') {
		var great = res.a;
		return great;
	} else {
...
var author$project$Main$updateUrl = F2(
	function (url, model) {
		var _n0 = A2(elm$url$Url$Parser$parse, author$project$Main$parser, url);
		if (_n0.$ === 'Just') {
			if (_n0.a.$ === 'HomeRoute') {
				var _n1 = _n0.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Common$HomePage(10)
						}),
				...
				if (_n0.a.a.$ === 'Nothing') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Common$ElmuiPage(
									author$project$Pages$Elmui$createModel('0')),
								url: url
							}),
						elm$core$Platform$Cmd$none);
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								page: author$project$Common$ElmuiPage(
									author$project$Pages$Elmui$createModel(val)),
								url: url
							}),
						elm$core$Platform$Cmd$none);
				}
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{page: author$project$Common$NotFound, url: url}),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$init = F3(
	function (flags, url, key) {
		return A2(
			...
			url,
			{key: key, page: author$project$Common$NotFound, url: url});
	});
...
var author$project$Main$toDirection = function (string) {
	switch (string) {
		...
		case 'ArrowRight':
			return author$project$Main$Increment;
		default:
...
var author$project$Main$GotElmuiMsg = function (a) {
	return {$: 'GotElmuiMsg', a: a};
};
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Common$ElmuiPage(folders)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$GotElmuiMsg, cmd));
	});
var author$project$Main$GotHomePageMsg = function (a) {
	return {$: 'GotHomePageMsg', a: a};
};
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Common$HomePage(home)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$GotHomePageMsg, cmd));
	});
var author$project$Pages$Elmui$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Increment':
		...
		switch (msg.$) {
			...
			case 'Increment':
				var incremented = function (val) {
					var _n4 = elm$core$String$toInt(val);
					if (_n4.$ === 'Just') {
						var v = _n4.a;
				...
				var _n2 = A2(elm$url$Url$Parser$parse, author$project$Main$parser, model.url);
				if (_n2.$ === 'Just') {
					if (_n2.a.$ === 'ElmuiQuery') {
						if (_n2.a.a.$ === 'Just') {
							var val = _n2.a.a.a;
							...
							return _Utils_Tuple2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												A2(elm$url$Url$Builder$string, 'q', '1')
											]))));
						}
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			case 'Decrement':
				var buildQuery = function (val) {
					var _n7 = elm$core$String$toInt(val);
					if (_n7.$ === 'Just') {
						var v = _n7.a;
						var res = v - 1;
						return (res > 0) ? _List_fromArray(
							[
								...
								elm$url$Url$Builder$string,
								'q',
								elm$core$String$fromInt(res))
							]) : _List_Nil;
					} else {
						return _List_Nil;
					}
				};
				var _n5 = A2(elm$url$Url$Parser$parse, author$project$Main$parser, model.url);
				if (_n5.$ === 'Just') {
					if (_n5.a.$ === 'ElmuiQuery') {
						if (_n5.a.a.$ === 'Just') {
							var val = _n5.a.a.a;
			...
			case 'GotElmuiMsg':
				...
				if (_n8.$ === 'ElmuiPage') {
					...
					return A2(
						...
						model,
						A2(author$project$Pages$Elmui$update, foldersMsg, folders));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_n9.$ === 'HomePage') {
					...
					return A2(
						...
						model,
						A2(author$project$Pages$Home$update, foldersMsg, folders));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$Style$colorBlue = A3(mdgriffith$elm_ui$Element$rgb255, 0, 111, 255);
...
var author$project$Pages$Elmui$view = function (model) {
	var content = A2(
		...
		_List_fromArray(
			[
				...
				A3(mdgriffith$elm_ui$Element$rgb255, 255, model * 10, 0))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Background$color(author$project$Style$colorBlue),
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Background$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 33, model * 10, 243)),
						mdgriffith$elm_ui$Element$Font$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
						mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$typeface('Futura'),
								mdgriffith$elm_ui$Element$Font$sansSerif
							]))
					]),
				mdgriffith$elm_ui$Element$text(
					'Page ' + elm$core$String$fromInt(model)))
			]));
	return A2(mdgriffith$elm_ui$Element$layout, _List_Nil, content);
};
var author$project$Style$colorPink = A3(mdgriffith$elm_ui$Element$rgb255, 255, 0, 111);
...
var author$project$Pages$Home$viewHeader = function () {
	var logo = A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Font$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
				mdgriffith$elm_ui$Element$Background$color(author$project$Style$colorPink)
			]),
		mdgriffith$elm_ui$Element$text('What is elm?'));
	var links = A2(
...
var author$project$Style$colorGreen = A3(mdgriffith$elm_ui$Element$rgb255, 111, 255, 0);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$centerX,
				mdgriffith$elm_ui$Element$centerY,
				mdgriffith$elm_ui$Element$Background$color(author$project$Style$colorGreen)
			]),
		author$project$Pages$Home$viewHeader);
};
	...
	var content = function () {
		...
		switch (_n0.$) {
			case 'ElmuiPage':
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$GotElmuiMsg,
					author$project$Pages$Elmui$view(elmui));
			case 'HomePage':
				var home = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$GotHomePageMsg,
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$float)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedLink":["Browser.UrlRequest"],"ChangedUrl":["Url.Url"],"GotElmuiMsg":["Pages.Elmui.Msg"],"GotHomePageMsg":["Pages.Home.Msg"],"Increment":[],"Decrement":[],"NoOp":[]}},"Pages.Elmui.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[],"NoOp":[]}},"Pages.Home.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});
...
},{"./Main.elm":"src/Main.elm"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
